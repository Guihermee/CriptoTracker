package br.com.cerniauskas.criptotracker.ui.theme
...
val primaryLightHighContrast = Color(0xFF1B4C23)
...
val errorLightHighContrast = Color(0xFFB22222) // Vermelho escuro, mas menos vibrante para o modo claro
val onErrorLightHighContrast = Color(0xFFFFFFFF) // Branco continua o mesmo para contraste
...
val primaryDarkHighContrast = Color(0xFFA2D8A1)
...
val errorDarkHighContrast = Color(0xFFFF5C5C) // Vermelho mais suave para o modo escuro
val onErrorDarkHighContrast = Color(0xFF000000) // Preto continua o mesmo para contraste
